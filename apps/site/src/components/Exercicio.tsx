  ...
  return (
    <div className="exercicio" data-respondeu={respondeu ? "true" : undefined}>
      ...
      <pre className="exercicio__codigo mono">
        <code>
          {/* A lacuna pode ser a primeira linha do trecho: aí não há "antes", e
              uma linha em branco no topo faria o código nascer torto. */}
          {exercicio.antes === "" ? null : (
            <>
              {exercicio.antes}
              {"\n"}
            </>
