...
import { CHAVE_DO_PLACAR, lerPlacar, registrar } from "./placar.js";

// `.tsx` de propósito: o projeto `dom` do vitest é quem casa com essa extensão, e
// é ele que tem `window`. Um `.ts` cairia no projeto `node`, sem localStorage.
